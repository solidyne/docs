...
- Compatible con Windows 7/11, Linux Ubuntu y macOS (reconocimiento automático).
- El sistema detecta:
...
- Entrada **Stream-In** TRS 1/4” con corte.
...
<Warning>
  **No conectar un módem USB directamente al puerto**. Puede causar **interferencias audibles**.\
  ...
  Esto también le permitirá reorientar el MODEM en caso de obtener la indicación de señal débil.
</Warning>