...
4. Get the IP using **Solidyne Multi-Discovery**.
  ...
  <Note>
     **Solidyne Multi-Discovery**
     ...
     If physical access to the console is not available, you can [**download the Multi-Discovery tool**](/en/DX816/816-discovery) that detects Solidyne devices connected to the network.
</Note>
