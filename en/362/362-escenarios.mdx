...
In **HD mode (High Definition)**, the Audimax 362HD can be used in applications requiring dynamic control or loudness enhancement **without FM transmission** (MPX disabled; see [HD Mode](/en/362/362-instalacion-audio)).
