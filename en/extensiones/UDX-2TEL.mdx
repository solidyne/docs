...
The **UDX 2TEL** expansion allows connection of **two landline telephones** and their associated telephone sets.

- **UDX 2TEL-P**\
  Includes controls to **seize the line** and **transfer it to the console**.\
...
Each telephone line works **independently** on a channel.

---

## UDX 2TEL Connection

Connection is made with two standard **STP RJ45–RJ45** cables connected **pin-to-pin** (Solidyne models **SOL-P50** or **SOL-P25**).
...
<img
  ...
  alt="Udx2tel Connection Sv"
  title="Udx2tel Connection Sv"
  className="mx-auto"
  style={{ width:"59%" }}
/>
...
<Warning>
  If there is **no dial tone** when seizing the telephone line, verify that the **LINE** and **TELEPHONE** connections are not reversed on the **UDX TEL** adapter.
</Warning>
...
<img
  ...
  alt="Udx 2tel Inputs Sv"
  title="Udx 2tel Inputs Sv"
  className="mx-auto"
  style={{ width:"60%" }}
/>
...
<img
  ...
  alt="Udx2tel Outputs Sv"
  title="Udx2tel Outputs Sv"
  className="mx-auto"
  style={{ width:"64%" }}
/>
