...
Access by pressing the **SCENES** option, available in the contextual buttons when the console shows the **main screen**.
...
- In **CHANNEL** screen can change **gain**, **pan**, **name**, **input assignment** and **channel mode**, but without accessing SETTINGS
...
<Note>
  Download [default scene configuration infographic](http://www.solidyne.dx.com.ar/wordpress-files/DW/doc-guides/UX24_Quickguide_Inputs_and_Outputs_features.pdf) (PDF)
</Note>
...
The **CHANNEL MAP** function shows configuration of all channels and allows easy reordering.\
...
2. Select from list the two channels to swap
...
3. Press **APPLY** to confirm
   - **APPLY** applies changes temporarily (not yet saved)
